<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">จัดการ admin </li>
        </ol>
    </section>
    <!-- Top menu -->
                                ...
                                <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row">
                                            ...
                                            <td>
                                                <a class="btn btn-danger btn-xs" href="<?php echo  base_url('admin/confrm/'.$data->id); ?>" role="button"><i class="fa fa-fw fa-trash"></i> ลบข้อมูล</a>
                                            </td>
                                        </tr>
                                        <?php } } ?>
                                    </tbody>
